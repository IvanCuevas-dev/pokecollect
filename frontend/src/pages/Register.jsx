    ...
    return (
        <div className="flex-1 flex items-center justify-center p-6">
            <div className="w-full max-w-md bg-white/5 border border-white/10 backdrop-blur-md rounded-2xl p-8">
                <h1 className="text-2xl font-bold tracking-wide text-center mb-8">Registro</h1>
                ...
                <form onSubmit={enviarRegistro} className="flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        />
                        {error.email && (
                            <p className="text-red-400 text-xs mt-1">{error.email[0]}</p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        />
                        {error.password && (
                            <p className="text-red-400 text-xs mt-1">{error.password[0]}</p>
                        )}
                    </div>

                    {error.general && (
                        <p className="text-red-400 text-sm text-center">{error.general[0]}</p>
                    )}
